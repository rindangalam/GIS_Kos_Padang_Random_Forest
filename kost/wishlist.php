          ...
          <div class="card kost-card">
            ...
            <div class="card-body d-flex flex-row">
              ...
              <div>
                ...
                <!-- Subtitle -->
                <div class="row">
                  <p class="card-text"><?php echo $d['kelurahan'] . ',' . $d['kecamatan'] ?></p>
                </div>
            ...
            <div class="view overlay">
              <img class="card-img-top rounded-0" src="https://picsum.photos/seed/<?php echo $d['id_kost']; ?>-kamar/400/240" alt="Kamar Kost">
              <a href="#!">
