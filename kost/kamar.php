...
<div class="container py-4">
  <div class="row justify-content-center">
    <div class="col-lg-7 col-md-10">
      <form class="shadow-lg rounded-4 p-4 bg-white" action="php/kamar_proses.php?id_kost=<?php echo $id_kost ?>" method="post" style="border:1.5px solid #b2ebeb;">
        <div class="text-center mb-4">
          <div style="font-size:2rem;color:#19a9a9;font-weight:bold;letter-spacing:1px;">
            <i class="fa fa-bed" style="margin-right:8px;color:#00b894;"></i>Tambah Kamar
          </div>
          <div style="color:#1565c0;font-size:1.05rem;">Lengkapi detail kamar kost Anda dengan fasilitas terbaik!</div>
        </div>
        <hr>
        ...
        <div class="row g-3 mb-3">
          <div class="col-md-6">
            ...
            <input type="number" name="panjang_kamar" id="panjang_kamar" class="form-control" step="0.01" required>
          </div>
          <div class="col-md-6">
            <label for="lebar_kamar" class="form-label">Lebar Kamar (m)</label>
            <input type="number" name="lebar_kamar" id="lebar_kamar" class="form-control" step="0.01" required>
          </div>
        </div>
        <div class="mb-3">
        ...
        <div class="row mb-4">
              ...
              <?php
                ...
                foreach ($fasilitas_kamar as $i => $f) {
                  echo '<div class="form-check me-3 mb-2" style="min-width: 140px;">
                          <input class="form-check-input" type="checkbox" name="fasilitas_kamar[]" value="'.$f['label'].'" id="fk'.$i.'">
         ...
         <div class="col-md-6">
            ...
            <div class="input-group">
              ...
              <input type="number" name="biaya_fasilitas" id="biaya_fasilitas" class="form-control" placeholder="0">
            </div>
            <div class="form-text">Biaya fasilitas akan ditambahkan ke harga sewa sebagai biaya tambahan.</div>
          </div>
        <div class="text-center">
          <button name="submit" type="submit" class="btn btn-primary px-5 py-2 rounded-pill" style="font-weight:bold;letter-spacing:1px;">
            <i class="fa fa-save me-2"></i>Tambah Kamar
          </button>
        </div>
      </form>
    </div>
